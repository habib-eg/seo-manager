<template>
    <td>
        <button v-if="editing && route.mapping" class="btn btn-sm btn-info" @click="openModal">Set Dynamic Title</button>
        <button v-else-if="editing && route.params.length" class="btn btn-sm btn-danger" @click="openMappingModal">Set
            Mapping
        </button>
        <p v-else class="data">
