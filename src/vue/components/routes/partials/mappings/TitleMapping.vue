        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{$t('main.open_graph_title_dynamic')}}</h5>
                ...
                <div class="modal-body">
                    <div id="data-form">
                        ...
                        <div class="form-row" v-if="example_title">
                            <div class="col-12 col-md-12">
                                <p><b>{{$t('main.example_title')}}:</b> {{ example_title }}</p>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-3 col-md-3">
                                <div class="form-group">
                                    <button type="button" @click="storeTitleDynamic"
                                        ...
                                        {{$t('main.save_open_graph_title_dynamic')}}
                                    </button>
                                </div>
                            </div>
