            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">{{$t('main.url')}}</h5>
                            ...
                            <div class="form-row">
                                <div class="col-12 col-md-12 mb-12">
                                    <div class="form-group">
                                        <input class="form-control" :placeholder="$t('main.leave_this_field_empty_to_set_url_to_current_route_url')" v-model="route.url">
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
