            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">{{$t('main.author')}}</h5>
                            ...
                            <div class="form-row">
                                <div class="col-12 col-md-12 mb-12">
                                    <div class="form-group">
                                        <input class="form-control" v-model="route.author">
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-2 col-md-2 mb-2">
                                    <div class="form-group">
                                        <button type="button" @click="storeAuthor"
...
<script>
    ...
    export default {
        ...
        methods: {
            closeModal() {
                EventBus.$emit('close-modal', 'author');
            },
            storeAuthor() {
                this.saving = true;
