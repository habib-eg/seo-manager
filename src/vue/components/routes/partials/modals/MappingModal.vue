            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">{{$t('main.params_mapping')}}</h5>
                    ...
                    <div class="modal-body">
                        <form id="data-form">
                            <div class="form-row" v-for="(param, index) in params" :key="index">
                                <div class="col-12 col-md-3 mb-3">
                                    <div class="form-group">
                                        <label>{{$t('main.param')}}</label>
                                        <p class="form-control">{{ index }}</p>
                                    </div>
                                </div>
                                <div class="col-12 col-md-3 mb-3">
                                    <div class="form-group">
                                        <label>{{$t('main.model')}}</label>
                                ...
                                <div class="col-12 col-md-3 mb-3">
                                    <div class="form-group">
                                        <label>{{$t('main.use_columns_for_mapping')}}: </label>
                            ...
                            <button @click="storeMapping" type="button" :class="{'is-loading': saving}"
                                    class="btn btn-primary submit_button">{{$t('main.map_data')}}
                            </button>
                        </form>
                    </div>
                </div>
