                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <div class="row align-items-center open-header">
                            <div class="col">
                                <h5 class="modal-title">{{$t('main.example_title')}}</h5>
                            </div>
                            <div class="col-auto">
                                <button class="btn btn-success preview" @click="preview">{{$t('main.preview')}}</button>
                            </div>
                            <div class="col-auto">
                            ...
                            <div class="form-row">
                                <div class="col-12 col-md-12">
                                    <table class="table text-left">
                                        <thead>
                                        <tr>
                                            <td>{{$t('main.save_title_dynamic')}}</td>
                                            <td>{{$t('main.open_graph')}}</td>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <tr v-if="ogData[key].visibility" v-for="(item, key, index) in ogData">
                                            ...
                                            <td>
                                                ...
                                                <div class="form-group" v-else>
                                                    ...
                                                    <p v-if="key === 'url'" class="url-feedback">{{$t('main.content')}}</p>
                                                </div>
                                ...
                                <div class="col-3 col-md-3">
                                    <div class="form-group">
                                        <button type="button"
                                            ...
                                            {{$t('main.select_og_type')}}
                                        </button>
                                        <span class="text-success" v-if="saved">{{$t('main.leave_this_field_empty')}}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
